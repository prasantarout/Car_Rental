...
function ProviderCompletedRidesDetails() {
    ...
    <View style={[css.f1, css.bgWhite]}>
      ...
      <SafeView>
        <View style={css.px10}>
          ...
          <Button
            title={'Send Feedback'}
            onPress={() => setfeedbackModal(!feedbackModal)}
            style={[css.my15]}
          />
          ...
          <View style={[styles.pickTimeView]}>
            <Text style={[styles.headingText1]}>Report an Issue</Text>

            <View style={[styles.imageTextView, {marginTop: normalize(15)}]}>
              <Text style={[styles.pickdateTime]}>Pick-up Location</Text>
            </View>
            <Input
              containerStyle={[css.f1, css.mt10]}
              style={{backgroundColor: 'white'}}
              placeholder="Enter email"
              value={bookingId}
              onChangeText={val => setBookingId(val)}
              inputMode="email"
            ...
            <MultilineTextInput
              ...
              textInputStyle={{backgroundColor: 'white', width: '100%'}}
              placeholder="Enter email"
              value={description}
...
export default ProviderCompletedRidesDetails;
